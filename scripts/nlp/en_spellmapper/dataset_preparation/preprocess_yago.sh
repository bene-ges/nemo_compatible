...
python ${NEMO_COMPATIBLE_PATH}/scripts/nlp/en_spellmapper/dataset_preparation/preprocess_yago.py --input_name yago.uniq --output_name yago.uniq2
python ${NEMO_COMPATIBLE_PATH}/scripts/nlp/en_spellmapper/dataset_preparation/extract_single_words_from_yago.py --input_name yago.uniq2 --output_name yago.vocab.txt
